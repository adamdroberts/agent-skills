...
For Codex, Gemini CLI, project-scoped Claude Code installs, and direct use without an agent runtime, see **[docs/install.md](docs/install.md)**.
...
| Codex | [.agents/skills/](.agents/skills/) | Symlinks to the canonical root skill folders. Codex discovers repository skills from `.agents/skills` and follows symlinks. |
...
- **[docs/](docs/)** — browsable documentation set.
  ...
  - [docs/architecture.md](docs/architecture.md) — repo layout, the canonical-folder + adapter pattern, Mermaid diagram of how the four distribution paths share one source.
  - [docs/contributing.md](docs/contributing.md) — step-by-step guide for adding a new skill end-to-end (canonical folder, four adapters, plugin manifest, marketplace entry, validation).
...
Stable. Two skills, four distribution channels, no breaking changes planned. New skills follow the contribution checklist in [docs/contributing.md](docs/contributing.md).
